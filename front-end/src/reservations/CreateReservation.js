...
//     // TODO refactor dateValidator into utils folder; be mindful of state management
...
//                 errors.push(
//                     "Sorry, but we cannot accept reservations for any time earlier than today."
//                 );
//             }
//             if (date.toFormat("ccc") === "Tue") {
//                 errors.push(
//                     "No reservations may be made on Tuesdays. Our restaurant is closed."
//                 );
//             }
...
//                 reservation_date: formData.get("reservation_id"),
...
//         // ?will wee need to make this handleSubmit work to also update existing reservations?
//     };
